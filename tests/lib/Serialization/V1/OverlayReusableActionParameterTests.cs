...
public class OverlayReusableActionParameterV1Tests
{
    [Fact]
...
""";
    ...
    [Fact]
    public void SerializeAsV1_WithDefault_ShouldWriteCorrectJson()
    {
        // Arrange
        var parameter = new OverlayReusableActionParameter
        {
...
""";
    ...
    [Fact]
    public void SerializeAsV1_WhenNameIsMissing_ShouldThrow()
    {
        // Arrange
        var parameter = new OverlayReusableActionParameter();
        using var textWriter = new StringWriter();
        ...
        // Act / Assert
        Assert.Throws<ArgumentNullException>(() => parameter.SerializeAsV1(writer));
    }
