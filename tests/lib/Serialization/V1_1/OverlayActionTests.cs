...
public class OverlayActionV1_1Tests
{
    [Fact]
...
""";
        ...
        // Act
        overlayAction.SerializeAsV1_1(writer);
...
""";
    ...
    [Fact]
    public void SerializeAsV1_1_WithUpdateArray_ShouldWriteCorrectJson()
    {
        // Arrange
        var updateNode = JsonNode.Parse("""
        ["tag1", "tag2", "tag3"]
...
""";
    ...
    public void Deserialize_ShouldSetPropertiesCorrectly()
    {
        ...
        // Act
        var overlayAction = OverlayV1_1Deserializer.LoadAction(jsonNode, parsingContext);
    ...
    public void Deserialize_WithNonBooleanRemove_ShouldThrow()
    {
        ...
        // Act + Assert
        Assert.Throws<InvalidOperationException>(() => OverlayV1_1Deserializer.LoadAction(jsonNode, parsingContext));
    }
    ...
    [Fact]
    public void SerializeAsV1_1_WithCopy_ShouldWriteCorrectJson()
    {
        // Arrange
        var overlayAction = new OverlayAction
        {
