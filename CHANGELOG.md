...
## [4.0.0-preview.0](https://github.com/BinkyLabs/openapi-overlays-dotnet/compare/v3.0.0-preview.0...v4.0.0-preview.0) (2026-04-06)
...
* add environment variables values resolution ([7afb8b3](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/7afb8b3988f7ac0382c1ed06d6b67769b49fe78c))
* add parameters and environment variables names validation ([7afb8b3](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/7afb8b3988f7ac0382c1ed06d6b67769b49fe78c))
...
* adds a method to resolve parameter values on the reference ([599730c](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/599730c91e49b02f0eebf00c35f5fe12ceb4d825))
...
* adds broken references validation ([6f00f18](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/6f00f187e8205bc2cfb1d3607bf9f390731ec33c))
...
* adds initial effective action resolution ([9506062](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/9506062ba9b40d7e0a60f84a3b18df285982518b))
* adds model definition for components ([71973fc](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/71973fcd7ff00fdad882d79b027a4c541b53c1a5))
* adds model for Reusable Action Parameter ([04a0468](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/04a04688bd885954d7745e80783221bd455ab923))
* adds models for reusable action reference ([17a5556](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/17a5556f96a062feeb309c69145dce8b0ff877d3))
...
* adds reading the actual environment variables ([83bbcce](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/83bbcce91a7e4efaaabeab0fc5b9cf7aa047c050))
* adds resolved action use when applying the changes to a document ([83bbcce](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/83bbcce91a7e4efaaabeab0fc5b9cf7aa047c050))
* adds reusable actions resolution ([051d51a](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/051d51aca926ef0c319de0901e8405a5ba0c369b))
...
* adds string interpolation support ([8ce8b52](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/8ce8b524e358ae4593ca9f24c93bcd2e3a3aedef))
...
* adds the components property to the document model ([d8c6b3c](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/d8c6b3cff3d988c6e0217e669a53e44f15439b88))
* adds the reusable action definition ([d7dbe61](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/d7dbe619dba71145e0ac1d6153e3394628ebbc7d))
* adds update value interpolation support ([62771fd](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/62771fd9517da5575c64a149d52d8383d6076cfc))
...
* BREAKING switch to an interface for the OverlayAction API surface ([0513faf](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/0513faf98580c4f0786ceef601211b7e4bb4846e))
...
* adds strong validation for missing reference during serialization ([6a4230d](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/6a4230de37d395544f397600bce5e14e661668e6))
* adds support for underscore in parameter names ([ff7ce0d](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/ff7ce0d23caf3211ff5b9576d51ffc32209becaf))
...
* do not leave dangling references without host document for resolution ([9afd77e](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/9afd77e61ed77122208fe0e1ac609ad1a87931bb))
...
* document combination for components ([c90c480](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/c90c480941d4d1fa17dc2108849228c7abc3fcaf))
...
* further experimental tagging of constants ([9480235](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/948023591271676428d8d2bb53c6f3005fa52e6e))
...
* makes x preview fields names experimental ([1c19d59](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/1c19d59406c43a08809e0bc410cdeb7542d2d74a))
* misalignments in pointers generation ([3430375](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/34303752545fd8961a954fddcaa5ddada11c9492))
* missing defensive programming on environment variables resolution ([e45bf6a](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/e45bf6a74d17ec84cdea04860b9418de6c9bc591))
* param/env name validation regex to account for underscore ([6d69ae5](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/6d69ae56df8841084f5834a2851c27dfd6f9a7c8))
* programmatically set references might fail to resolve during apply if host document is not set ([71a3d62](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/71a3d6247b4061d79270ade6744d0b966ef83be2))
* regression with lazy initialization ([50b4906](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/50b490660af49d5929fed3e61049c90fdaea201c))
...
* return an error instead of throwing upon unknown action type ([90bf798](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/90bf79805ee31dd63084e69bceb90899b28e88d6))
...
* updates outdated links in the doc comments ([8770c54](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/8770c54a354c4f11b8b3b0ddae6df03bd5ebd72b))
...
* use the index for actions resolution error ([e1605b7](https://github.com/BinkyLabs/openapi-overlays-dotnet/commit/e1605b7d9874cbe52e2185aab00c191279536eea))
