...
internal static partial class OverlayV1Deserializer
{
    public static readonly FixedFieldMap<OverlayDocument> DocumentFixedFields = new()
    {
        ...
        { OverlayConstants.DocumentExtendsFieldName, (o, v, _) => o.Extends = v.GetScalarValue() is string rawUri && Uri.TryCreate(rawUri, UriKind.RelativeOrAbsolute,  out var result) ? result : null },
